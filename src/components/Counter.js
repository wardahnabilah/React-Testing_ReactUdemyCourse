...
export function Counter() {
  ...
  return (
    <section>
        <form>
        <textarea onChange={handleChange} ref={inputRef} className="w-[32rem] h-[16rem] pt-2 pl-3 border-2 border-slate-600" type="text" placeholder="Type or paste your text" />
      </form>
